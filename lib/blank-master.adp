...
<body<if @body.class@ not nil> class="@body.class;noquote@"</if><if @body.id@ not nil> id="@body.id;noquote@"</if><if @event_handlers@ not nil>@event_handlers;noquote@</if> <if @body_attributes@ not nil> @body_attributes;noquote@</if>>
  @header;noquote@
<slave>
<footer>
  @footer;noquote@
